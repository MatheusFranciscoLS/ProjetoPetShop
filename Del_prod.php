...
<head>
    ...
    <!-- Inclui os estilos do Bootstrap -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet"
        integrity="sha384-T3c6CoIi6uLrA9TneNEoa7RxnatzjcDSCmG1MXxSR1GAsXEV/Dwwykc2MPK8M2HN" crossorigin="anonymous">

    <!-- Inclui o estilo personalizado do cadastro de produtos -->
...
<body>
    ...
    if (isset($_GET['id'])) {
        ...
        // Executa a consulta SQL para selecionar o produto com base no 'id'
        $query = "SELECT * FROM produto WHERE id = $produto_id";
        $result = mysqli_query($conn, $query) or die("Impossível executar a query");

        // Obtém a primeira linha do resultado como um objeto
    ...
    <form action="cadprodutosDAO.php" method="post" enctype="multipart/form-data">
        ...
        <!-- Botões para Excluir e Cancelar -->
        <div class="botao">
